...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>License &mdash; PyiUpdater 0.15.1-beta2-dirty documentation</title>
    ...
    <link rel="next" title="Release History" href="release_history.php" />
    <link rel="prev" title="API" href="api.php" />
<meta charset='utf-8'>
...
<li><a class="reference internal" href="#">License</a></li>
  ...
  <li>
    <a href="api.php" title="Previous Chapter: API"><span class="glyphicon glyphicon-chevron-left visible-sm"></span><span class="hidden-sm hidden-tablet">&laquo; API</span>
    </a>
  </li>
  <li>
    <a href="release_history.php" title="Next Chapter: Release History"><span class="glyphicon glyphicon-chevron-right visible-sm"></span><span class="hidden-sm hidden-tablet">Release History &raquo;</span>
    </a>
  </li>
...
<p>Copyright 2014 Digital Sapphire Development Team</p>
