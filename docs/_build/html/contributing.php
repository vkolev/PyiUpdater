...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Contributing &mdash; PyiUpdater 0.15.1-beta2-dirty documentation</title>
    ...
    <link rel="prev" title="File &amp; Folder Structure" href="folder_structure.php" />
<meta charset='utf-8'>
...
<li><a class="reference internal" href="#code-style">Code Style</a></li>
  ...
  <li>
    <a href="folder_structure.php" title="Previous Chapter: File & Folder Structure"><span class="glyphicon glyphicon-chevron-left visible-sm"></span><span class="hidden-sm hidden-tablet">&laquo; File & Folder St...</span>
    </a>
  </li>
  <li>
    <a href="api.php" title="Next Chapter: API"><span class="glyphicon glyphicon-chevron-right visible-sm"></span><span class="hidden-sm hidden-tablet">API &raquo;</span>
    </a>
  </li>
...
<p>Since PyiUpdater is close to v1.0 the goal is to make it as stable as possible. So for the time being no pull requests will be accepted that add new features until PyiUpdater is out of beta.</p>
<p>Fixing bugs &amp; filing issues are very welcome &amp; encouraged.</p>
<div class="section" id="code-style">
<h2>Code Style<a class="headerlink" href="#code-style" title="Permalink to this headline">¶</a></h2>
<p>Let&#8217;s try to stick to pep 8 as much as possible.</p>
</div>
</div>
