...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Welcome to PyiUpdater &mdash; PyiUpdater 0.15.1-beta2-dirty documentation</title>
    ...
    <link rel="top" title="PyiUpdater 0.15.1-beta2-dirty documentation" href="#" />
...
<li><a class="reference internal" href="#">Welcome to PyiUpdater</a><ul>
<li><a class="reference internal" href="#what-is-pyiupdater">What is PyiUpdater?</a></li>
...
<li><a class="reference internal" href="#indices-and-tables">Indices and tables</a></li>
  ...
  <li>
    <a href="downloads.php" title="Next Chapter: Downloads"><span class="glyphicon glyphicon-chevron-right visible-sm"></span><span class="hidden-sm hidden-tablet">Downloads &raquo;</span>
    </a>
  </li>
...
<div class="container">
  ...
  <div class="section" id="welcome-to-pyiupdater">
<h1>Welcome to PyiUpdater<a class="headerlink" href="#welcome-to-pyiupdater" title="Permalink to this headline">¶</a></h1>
<div class="section" id="what-is-pyiupdater">
<h2>What is PyiUpdater?<a class="headerlink" href="#what-is-pyiupdater" title="Permalink to this headline">¶</a></h2>
<p>In its simplest form PyiUpdater is a collection of modules, when used together, makes its super simple to add auto-update functionality to your app. Support for patch updates are included out of the box :)</p>
<p>A high level break down of the framework consists of 3 parts.</p>
<dl class="docutils">
<dt>Client</dt>
<dd>Is the module you import into your app that provides the update functionality. It also uses the Patcher module internally.</dd>
<dt>Core</dt>
<dd>Consists of the Archiver, Downloader, FileCrypt, KeyHandler, PackageHandler &amp; Utils.</dd>
<dt>CLI</dt>
<dd>Command line program to help automate the update creation process</dd>
</dl>
</div>
...
<ul>
<li class="toctree-l1"><a class="reference internal" href="downloads.php">Downloads</a><ul>
<li class="toctree-l2"><a class="reference internal" href="downloads.php#source-downloads">Source Downloads:</a></li>
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="installation.php">Installation</a></li>
<li class="toctree-l1"><a class="reference internal" href="configuration.php">Configuration</a></li>
...
<li class="toctree-l1"><a class="reference internal" href="architecture.php">Architecture</a></li>
<li class="toctree-l1"><a class="reference internal" href="folder_structure.php">File &amp; Folder Structure</a><ul>
<li class="toctree-l2"><a class="reference internal" href="folder_structure.php#program-src-directory">Program Src Directory</a></li>
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="contributing.php">Contributing</a><ul>
<li class="toctree-l2"><a class="reference internal" href="contributing.php#code-style">Code Style</a></li>
</ul>
</li>
<li class="toctree-l1"><a class="reference internal" href="api.php">API</a></li>
<li class="toctree-l1"><a class="reference internal" href="license.php">License</a></li>
...
<li class="toctree-l2"><a class="reference internal" href="release_history.php#v0-12-0-2014-11-29">v0.12.0 - 2014/11/29</a></li>
<li class="toctree-l2"><a class="reference internal" href="release_history.php#v0-11-0-2014-11-22">v0.11.0 - 2014/11/22</a></li>
<li class="toctree-l2"><a class="reference internal" href="release_history.php#v0-10-0-2014-11-16">v0.10.0 - 2014/11/16</a></li>
<li class="toctree-l2"><a class="reference internal" href="release_history.php#v0-9-2-2014-10-19">v0.9.2 - 2014/10/19</a></li>
<li class="toctree-l2"><a class="reference internal" href="release_history.php#v0-9-1-2014-10-19">v0.9.1 - 2014/10/19</a></li>
<li class="toctree-l2"><a class="reference internal" href="release_history.php#v0-9-0-2014-10-18">v0.9.0 - 2014/10/18</a></li>
<li class="toctree-l2"><a class="reference internal" href="release_history.php#v0-8-1-2014-9-3">v0.8.1 - 2014/9/3</a></li>
<li class="toctree-l2"><a class="reference internal" href="release_history.php#v0-8-0-2014-8-31">v0.8.0 - 2014/8/31</a></li>
<li class="toctree-l2"><a class="reference internal" href="release_history.php#v0-7-2-2014-8-10">v0.7.2 - 2014/8/10</a></li>
<li class="toctree-l2"><a class="reference internal" href="release_history.php#v0-7-1-2014-8-10">v0.7.1 - 2014/8/10</a></li>
<li class="toctree-l2"><a class="reference internal" href="release_history.php#v0-7-2014-8-3">v0.7 - 2014/8/3</a></li>
<li class="toctree-l2"><a class="reference internal" href="release_history.php#v0-6-0-2014-7-27">v0.6.0 - 2014/7/27</a></li>
</ul>
</li>
</ul>
</div>
